...
${OBJECTDIR}/src/AstParser.o: src/AstParser.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/AstParser.o src/AstParser.cpp

${OBJECTDIR}/src/CppHtmliser.o: src/CppHtmliser.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CppHtmliser.o src/CppHtmliser.cpp
...
${OBJECTDIR}/src/TokenParser.o: src/TokenParser.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TokenParser.o src/TokenParser.cpp
